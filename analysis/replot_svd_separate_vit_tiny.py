...
def main():
    ...
    results_path = Path("Output/vit_tiny_patch16_224_21k/svd/svd_results.npz")
    output_dir = Path("Output/vit_tiny_patch16_224_21k/svd")
    ...
    # ViT-Tiny has 12 layers, so last is 11
    last_layer_idx = 11
