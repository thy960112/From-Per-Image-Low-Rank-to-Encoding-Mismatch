...
def plot_results(stats, output_dir):
    ...
    middle_idx = 11  # Middle layer for 24-layer model (0-23)
...
def main():
    ...
    results_path = Path("Output/vit_large_21k_in1k/svd_layers/layer_wise_svd_results.npz")
    output_dir = Path("Output/vit_large_21k_in1k/svd_layers")
