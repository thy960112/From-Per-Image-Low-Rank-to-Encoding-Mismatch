...
def main():
    ...
    results_path = Path("Output/vit_huge_patch14_224_mae/svd/svd_results.npz")
    output_dir = Path("Output/vit_huge_patch14_224_mae/svd")
    ...
    # ViT-Huge has 32 layers, so last is 31
    last_layer_idx = 31
